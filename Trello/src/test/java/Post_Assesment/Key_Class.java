...
public class Key_Class {
	...
	public void Actions() throws Exception {
		...
		driver.findElement(By.id("user")).sendKeys("gpks1998@gmail.com");
		driver.findElement(By.id("login")).click();
		Thread.sleep(5000);
		driver.findElement(By.id("password")).sendKeys("Aridra_1498");
		...
		driver.findElement(By.xpath("//input[@placeholder='Add board title']")).sendKeys("GOA TRIP preparations");
		...
		System.out.println("TO-DO list has been created");

		driver.findElement(By.name("name")).sendKeys("DOING");
		driver.findElement(By.xpath("//input[@value='Add list']")).click();
		System.out.println("DOING list has been created");

		driver.findElement(By.name("name")).sendKeys("DONE");
		driver.findElement(By.xpath("//input[@value='Add list']")).click();	
		System.out.println("DONE list has been created");
		...
		WebElement Card1 = driver.findElement(By.xpath("//*[@class='nch-button nch-button--primary confirm mod-compact js-add-card']"));
		Card1.click();
		...
		WebElement AddCard2 = driver.findElement(By.xpath("//*[@class='nch-button nch-button--primary confirm mod-compact js-add-card']"));
		AddCard2.click();
		...
		WebElement AddCard3 = driver.findElement(By.xpath("//*[@class='nch-button nch-button--primary confirm mod-compact js-add-card']"));
		AddCard3.click();
		...
		System.out.println("Card 1 is moved from TO-DO to DOING");
		...
		System.out.println("Card 2 is moved from TO-DO to DOING");
		...
		System.out.println("Card 3 is moved from TO-DO to DOING");
		...
		System.out.println("Card 1 is moved from DOING to DONE");
		...
		System.out.println("Card 2 is moved from DOING to DONE");
		...
		System.out.println("Card 3 is moved from DOING to DONE");
	}
	@AfterTest
